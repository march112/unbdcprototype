...
def predict():
    ...
    return render_template('index.html', prediction_text=' Our Naive Bayes Multinomial Model predicts your tweet is {0}. \nOur Naive Bayes Complement Model predicts your tweet is {1}. \nRandom Forest Model predicts your tweet is {2}. Our K Nearest Neighbours Model predicts your tweet is {3}. Our Support Vector Machine Model predicts your tweet is {4}. Our Logistic Regression model predicts your tweet is {5}'.format(final1, final2, final3, final4, final5, final6))
